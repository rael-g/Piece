...
#include <ral/irender_context.h> // For MockRenderContext
...
#include <ral/itexture.h> // For MockGraphicsDevice
#include <ral/isampler.h> // For MockGraphicsDevice
#include <ral/icompute_buffer.h> // For MockGraphicsDevice
