...
extern "C"
{
    PIECE_INTERMEDIATE_API void PieceIntermediate_SetGraphicsDeviceFactory(
        Piece::Intermediate::IGraphicsDeviceFactory *factory_ptr, const NativeVulkanOptions *options);

    PIECE_INTERMEDIATE_API void PieceIntermediate_SetWindowFactory(Piece::Intermediate::IWindowFactory *factory_ptr,
                                                                   const NativeWindowOptions *options);

    PIECE_INTERMEDIATE_API void PieceIntermediate_SetPhysicsWorldFactory(
        Piece::Intermediate::IPhysicsWorldFactory *factory_ptr, const NativePhysicsOptions *options);
